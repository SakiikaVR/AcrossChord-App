...
- 🔢 **NNS 表記** — `2△7`、`7sus4add9`、テンション、omit、オンコード (`/7#`) などを表示。NNS モードではダイアグラムを生成しません
...
NNS モードでは、`[Dmaj7]` や `[G7sus4add9]` のように入力した通常のコード名を度数へ自動変換します。
主な品質表記は `△7`、`-△7`、`7`、`6`、`9`、`11`、`13`、`add9/11/13`、`(69)`、
`sus2/4`、`dim7`、`blk`、各種テンション・alter・omit・ベース音変更です。
...
コード変換と全チューニングのダイアグラム回帰テストは `node tests\chord-engine.test.js` で実行できます。
